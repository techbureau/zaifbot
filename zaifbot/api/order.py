...
class Order:
    ...
    def time_limit_cancel(self, bot_order_id, currency_pair, wait_sec):
        return self._menu.time_limit_cancel(self._api, bot_order_id, currency_pair, wait_sec)

    def price_boundary_cancel(self, bot_order_id, currency_pair, target_margin):
        return self._menu.price_boundary_cancel(self._api, bot_order_id, currency_pair, target_margin)
